...
const requiredFiles = [
  ...
  "Pulumi.dns.yaml.example",
  "Pulumi.waf-dev.yaml.example",
  "Pulumi.waf-staging.yaml.example",
  "Pulumi.waf-prod.yaml.example",
  "Pulumi.ingress-dev.yaml.example",
  "Pulumi.ingress-staging.yaml.example",
  "Pulumi.ingress-prod.yaml.example",
  "Pulumi.argocd-platform-dev.yaml.example",
  "Pulumi.argocd-platform-staging.yaml.example",
  "Pulumi.argocd-platform-prod.yaml.example",
  "Pulumi.argocd-execution-dev.yaml.example",
  "Pulumi.argocd-execution-staging.yaml.example",
  "Pulumi.argocd-execution-prod.yaml.example",
  "Pulumi.backup-dev.yaml.example",
